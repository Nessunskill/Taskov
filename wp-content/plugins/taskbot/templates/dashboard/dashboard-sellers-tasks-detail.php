...
$terms_conditions_page      = !empty($taskbot_settings['tpl_terms_conditions']) ? get_the_permalink($taskbot_settings['tpl_terms_conditions']) : 'javascript:void(0);';
                    ...
                    <div class="tb-popupbtnarea">
                        <div class="tb-checkterm">
                            <div class="tb-checkbox">
                                ...
                                <label for="check3">
                                    <span>
                                        <?php esc_html_e('By clicking you agree with our', 'taskbot'); ?>
                                        <a href="<?php echo esc_url($terms_conditions_page);?>"><?php esc_html_e('terms & conditions', 'taskbot'); ?></a>
                                    </span>
                                </label>
                            </div>
                        </div>
